...
(async function load(){ 
    ...
    function featuringTemplate(peli){
     ...
     setAttributes($loader, {
        ...
        const HTMLString = featuringTemplate(pelis[0]); //este objeto lo obtuvimos haciendo un debbugin cuando e ejecuta el qery para saber la donde buscar 
    ...
    // console.log(actionList, dramaList, animationList)  //muesra en la consola
